export default function AgreeStore(){
  return(
    <>
...
3. 재화 등의 구매 관련 지원 업무
4. 대금의 결제 및 정산 관련 업무
5. 이용자의 특성에 기반한 맞춤형 콘텐츠 추천 서비스의 제공 업무
6. 기타 전자상거래와 관련하여 “회사”가 정하는 업무
...
⑤ “회사”는 “회원”의 아이디가 도용 등으로 의심이 되는 경우, “회원”의 정보보호를 위해 해당 아이디의 사용 중지 등의 제재 조치를 취할 수 있습니다.

제10조(회원의 ID 및 비밀번호에 대한 의무)
① “회원”이 “몰” 이용을 위하여 생성한 아이디와 비밀번호(이하 “계정정보”)에 관한 관리책임은 회원 본인에게 있으며, “회원”은 “계정정보”를 판매, 양도, 대여, 공유 등 제3자에게 제공, 공개하거나 이용하도록 해서는 안 됩니다.
② “회원”이 본인의 “계정정보”의 유출 또는 제3자가 이용하고 있음을 인지하고도 비밀번호를 변경하지 않은 경우 또는 이와 같은 사정을 “회사”에 통지하지 않거나 “회사”의 조치에 응하지 않은 경우 등 “회원”이 본 조의 의무를 준수하지 않아 발생하는 모든 손실이나 손해 등 불이익에 대한 일체의 책임은 “회원”에게 있습니다.
③ “회원”의 “계정정보”가 외부에 유출되었다고 의심되는 경우 “회사”는 개인정보 유출 등을 방지하기 위하여 “회원”의 “몰” 이용을 일부 제한하는 등의 보호조치를 취할 수 있습니다.
...
9. “회사”와 사전 협의 또는 동의 없이 데이터 등을 추출하기 위하여 에이전트(Agent), 로봇(Robot), 크롤러(Crawler), 스크립트(Script), 스파이더(Spider), 스파이웨어(Spyware), 매크로 프로그램 등의 자동화된 수단이나 수동 프로세스를 사용하여 “몰” 등 “회사”가 제공하는 서비스 및 서버에 접속하거나 “몰” 등 “회사”가 제공하는 서비스 및 서버에 포함된 콘텐츠 및 정보를 복사, 수집하거나 모니터링하는 행위
10. “몰”과 서버 간의 전송 내용 등을 확인하거나 소스 코드 등의 추출을 시도하기 위해 패킷 캡처 및 이와 유사·동일한 기능의 프로그램 등을 사용하여 “몰” 등 “회사”가 제공하는 서비스 및 서버에 접근하거나 해당 프로그램 등을 통하여 알게된 소스 코드(URL 포함) 및 명령 구문 등을 사용하여 “몰” 등 “회사”가 제공하는 서비스 및 서버에 접근하는 행위
...
⑤ "회원"은 "회사"가 별도로 허용한 경우를 제외하고는 "무신사 적립금"을 제3자에게 또는 다른 아이디로 양도할 수 없으며 유상으로 거래하거나 현금으로 전환할 수 없습니다.
...
⑦ "회원" 탈퇴 시 또는 “회원”이 “몰”에 마지막으로 로그인한 날로부터 1년이 경과할 경우(이하 "휴면상태") 그 때까지 사용하지 않은 "무신사 적립금"은 즉시 소멸되며, 탈퇴 후 재가입하거나 다시 로그인을 하더라도 소멸된 "무신사 적립금"은 복구되지 아니합니다.

제15조(무신사 포인트)
① "회사"는 "회원"이 이벤트 참여 등 “회사”가 정한 판촉 활동에 참여하는 경우 ”회사”가 정한 기준에 따라 일정한 "무신사 포인트"를 부여할 수 있습니다.
② "무신사 포인트"는 회원 등급의 산정 용도로만 사용됩니다.
③ "무신사 포인트"의 적립 기준, 사용 목적, 사용 방법, 사용기한 등은 내부 방침에 의하여 변경될 수 있으며, 이 경우 “회사”는 변경 내용을 “회원”이 알 수 있도록 사전에 공지합니다.
④ “무신사 포인트”의 유효 기간은 부여일로부터 5년이며, 유효기간 만료 시 자동으로 소멸됩니다.
...
② “회사”는 관련 법령에 따라 “회사”가 부담해야하는 책임 및 “몰”의 운영 및 관리 책임을 부담하고, “몰”에서의 “판매자”와 “이용자” 간의 재화 등의 거래와 관련하여 “이용자” 또는 “판매자”를 대리하지 아니하며, “회사”의 고의 또는 과실이 없는 이상 “이용자”와 “판매자” 간 재화 등의 거래에 대한 위험과 책임은 거래 당사자가 부담합니다.
③ “회사”는 관련 법령에 따라 “회사"가 책임을 부담하는 경우를 제외하고는 “몰”에서의 “판매자”와 “이용자” 간의 상품 거래와 관련하여 거래당사자의 판매 의사 또는 구매 의사의 존부 및 진정성, 상품의 품질, 완전성, 안정성, 적법성 및 타인의 권리에 대한 비침해성, “판매자”가 제공하거나 등록한 정보 및 자료의 진실성 또는 적법성 등을 보증하지 아니하며, “회사”의 고의 또는 과실이 없는 이상 “이용자”와 “판매자” 간의 상품 거래에 관한 위험과 책임은 거래 당사자가 부담합니다.
...
② 재화 등의 배송과 관련하여 “이용자”과 “판매자”, 배송업체, 금융기관 등 사이에 분쟁이 발생하는 경우 당사자들 간에 해결하는 것을 원칙으로 하며, 이와 관련하여 “회사”의 고의 또는 과실이 없는 한 “회사”는 어떠한 책임도 부담하지 않습니다.
...
③ “이용자”가 “회사”의 서비스를 이용하면서 작성한 상품평, Q＆A 등 게시물의 저작권은 해당 “이용자” 본인에게 있으며, 해당 게시물이 타인의 저작권 및 기타 지적재산권을 침해하는 경우 회사의 고의 또는 과실이 없는 한 그에 대한 책임은 “이용자” 본인이 부담합니다.
④ “회사”는 게시물이 다음 각 호의 어느 하나에 해당하는 경우, 사전 통보 없이 해당 게시물을 삭제하거나 다른 “이용자”가 볼 수 없도록 임시조치를 취할 수 있으며 “몰”의 이용이 제한될 수 있습니다. 단, “회사”는 게시물이 단순히 “회사” 또는 “판매자”에게 불리하다는 이유만으로 삭제 또는 임시조치를 취하지 않으며 회사가 임시조치를 취하거나 “몰”의 이용을 제한하는 경우 “이용자”는 회사에 30일 내 이의를 제기하여 구제받을 수 있습니다.
...
⑤ “이용자”는 “몰” 내에 게시한 저작물을 “회사”가 국내 또는 국외에서 다음 각호의 목적에 따라 필요한 범위 내에서 해당 콘텐츠를 복제,배포,전송,전시 할 수 있으며, 본질적인 내용을 변경하지 않는 범위 내에서 수정, 편집, 번역 할 수 있습니다. 다만, “이용자”가 해당 저작물의 삭제를 요청하는 경우, “회사”는 “이용자”의 요청에 협조할 수 있습니다.
...
제1조 (시행일)
이 이용약관은 2023년 8월 15일부터 시행합니다.

제2조 (적립금 제도 변경의 시행일)
약관 시행일 이전에 적립되어 사용하지 아니한 적립금에 관해서는 6개월이 경과한 후(이하 “적립금 제도 적용일”)부터 개정 약관 제14조 제7항을 적용합니다. 따라서 적립금 제도 적용일 현재 휴면상태에 있는 회원의 적립금은 약관 시행일 이전에 적립된 것이라고 할지라도 적립금 제도 적용일에 소멸됩니다.

[부칙]
2024. 3. 28. 개정

제1조 (시행일)
이 이용약관은 2024년 3월 28일부터 시행합니다.

제2조 (포인트 제도 변경의 시행일)
② 약관 시행일 이전에 적립된 무신사 포인트에 관해서는 2024년 7월 28일(이하 “포인트 제도 적용일”)부터 개정 약관 제15조 제5항을 적용합니다. 따라서 포인트 제도 적용일 현재 휴면상태에 있는 회원의 무신사 포인트는 약관 시행일 이전에 적립된 것이라고 할지라도 포인트 제도 적용일에 소멸됩니다.</p>
    </>
  )
}